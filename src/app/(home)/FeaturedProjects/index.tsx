...
export default function FeaturedProjects() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`max-w-360 mx-auto px-8 transition-all duration-700 ${
      ...
      >
        {projects.map((project, idx) => {
          ...
          return (
            ...
            >
              <div className="block w-full h-full" style={{ color: "inherit" }}>
                <div
      ...
      <div className="max-w-360 mx-auto px-8 mt-8">
        ...
        <div
          className={`flex justify-end transition-all duration-700 delay-300 ${
            inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
          }`}
        >
          <Button
            className="bg-transparent border border-white text-white font-semibold px-6 py-3 hover:bg-white hover:text-[#4758E0] transition-colors rounded-xl"
            onClick={() =>
